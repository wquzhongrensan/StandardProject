...
@implementation JPBaseNetwork
-(void)cn_GetRequesWithParams:(NSDictionary *)params UrlString:(NSString *)aUrl andCompletion:(BaseComplectionBlock)completion{
    
    [JPNetworkManager GET:[self noWhiteSpaceString:aUrl] parameters:params responseSeializerType:ResponseSeializerTypeJSON success:^(id responseObject) {
        // 处理数据
